...
public interface ServiceEvaluationMapper {
    ...
    @Select("select patient_id from service_evaluation where service_evaluation_id=#{serviceEvaluationId}")
    int ensurePatientById(int serviceEvaluationId);
    ...
    @Options(useGeneratedKeys = true,keyColumn = "service_evaluation_id",keyProperty = "serviceEvaluationId")
    void addServiceEvaluation(ServiceEvaluation serviceEvaluation);
}
