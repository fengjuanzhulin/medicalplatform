...
public class ServiceEvaluationServiceImpl implements ServiceEvaluationService {
    ...
    public void addServiceEvaluation(ServiceEvaluation serviceEvaluation) {
        ...
        serviceEvaluationMapper.addServiceEvaluation(serviceEvaluation1);
        return ;
    }

    @Override
    public int ensurePatientById(int serviceEvaluationId) {
        return serviceEvaluationMapper.ensurePatientById(serviceEvaluationId);
    }
